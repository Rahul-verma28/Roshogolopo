...
export function ProductsClient() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProducts(fetchParams))
  }, [currentFilter, searchQuery, sortBy, sortOrder, minPrice, maxPrice, inStock])
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-red-600 mb-2">Error Loading Products</h3>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <h1 className="text-2xl lg:text-4xl font-bold text-[var(--roshogolpo-gold)] mb-4 font-playfair">
          {currentFilter !== "all" 
            ? `${currentFilter.charAt(0).toUpperCase() + currentFilter.slice(1)} - Bengali Sweets`
      ...
      >
        <div className="text-gray-600">
          <p>
            ...
            {pagination && (
              <span> ({pagination.totalProducts} total)</span>
            )}
            {currentFilter !== "all" && (
              <span className="ml-1">
                in{" "}
